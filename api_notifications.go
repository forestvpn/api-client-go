...
type NotificationsApi interface {
	...
	*/
	...
	ListNotificationsExecute(r ApiListNotificationsRequest) ([]NotificationAllList, *http.Response, error)
	...
	*/
	UpdateNotificationMarkRead(ctx context.Context, slug int32) ApiUpdateNotificationMarkReadRequest
...
GetNotificationsUnreadCount Get unread notifications count
 ...
 @return ApiGetNotificationsUnreadCountRequest
*/
func (a *NotificationsApiService) GetNotificationsUnreadCount(ctx context.Context) ApiGetNotificationsUnreadCountRequest {
	return ApiGetNotificationsUnreadCountRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return NotificationUnreadCount
func (a *NotificationsApiService) GetNotificationsUnreadCountExecute(r ApiGetNotificationsUnreadCountRequest) (*NotificationUnreadCount, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "NotificationsApiService.GetNotificationsUnreadCount")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/notifications/unread_count/"
...
func (r ApiListNotificationsRequest) Offset(offset int32) ApiListNotificationsRequest {
	r.offset = &offset
	return r
}

func (r ApiListNotificationsRequest) Type_(type_ string) ApiListNotificationsRequest {
	r.type_ = &type_
	return r
}

func (r ApiListNotificationsRequest) Execute() ([]NotificationAllList, *http.Response, error) {
...
// Execute executes the request
//  @return []NotificationAllList
func (a *NotificationsApiService) ListNotificationsExecute(r ApiListNotificationsRequest) ([]NotificationAllList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  []NotificationAllList
	)
	...
	localVarPath := localBasePath + "/notifications/all_list/"
...
UpdateNotificationMarkRead Mark notification as read by user
 ...
 @return ApiUpdateNotificationMarkReadRequest
*/
func (a *NotificationsApiService) UpdateNotificationMarkRead(ctx context.Context, slug int32) ApiUpdateNotificationMarkReadRequest {
	return ApiUpdateNotificationMarkReadRequest{
		ApiService: a,
		ctx: ctx,
		slug: slug,
...
// Execute executes the request
func (a *NotificationsApiService) UpdateNotificationMarkReadExecute(r ApiUpdateNotificationMarkReadRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "NotificationsApiService.UpdateNotificationMarkRead")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/notifications/mark_as_read/{slug}/"
...
UpdateNotificationMarkReadAll Mark all notifications as read by user
 ...
 @return ApiUpdateNotificationMarkReadAllRequest
*/
func (a *NotificationsApiService) UpdateNotificationMarkReadAll(ctx context.Context) ApiUpdateNotificationMarkReadAllRequest {
	return ApiUpdateNotificationMarkReadAllRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *NotificationsApiService) UpdateNotificationMarkReadAllExecute(r ApiUpdateNotificationMarkReadAllRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "NotificationsApiService.UpdateNotificationMarkReadAll")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/notifications/mark_all_as_read/"
